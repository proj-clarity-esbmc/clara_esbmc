#ifndef CLARITY_FRONTEND_CLARITY_CONVERT_H_
#define CLARITY_FRONTEND_CLARITY_CONVERT_H_
...
#include <clarity-frontend/pattern_check.h>

class clarity_convertert
{
public:
  clarity_convertert(
    contextt &_context,
...
// end of helper functions
  ...
  bool get_block(
    ...
    exprt &
      new_expr); // For Clarity's mutually inclusive: rule block and rule statement
  ...
  contextt &context;
  namespacet ns;
  // json for Clarity AST. Use vector for multiple contracts
  nlohmann::json &src_ast_json;
  // Clarity function to be verified
  const std::string &clar_func;
