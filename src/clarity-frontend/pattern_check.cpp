  ...
  const nlohmann::json &func)
{
  ...
  log_debug("clarity", "statements in function body array ... \n");
...
/* TODO: require() is like abort:
https://docs.soliditylang.org/en/latest/cheatsheet.html#validations-and-assertions

tx.origin vs msg.sender: tx-sender vs contract-caller
see also tx-sponsor? https://docs.stacks.co/clarity/keywords#tx-sponsor-clarity2
*/
